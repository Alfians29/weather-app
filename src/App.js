...
// API key
const APIkey = 'f1f3ec0b07faac9845dc79f4e2675614';
  ...
  if (!data) {
    return (
      <div className='w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col justify-center items-center'>
        <div>
          <ImSpinner8 className='text-[40px] animate-spin text-white' />
        </div>
      </div>
    );
  }
      ...
      >
        <div className='h-full relative flex items-center justify-between p-2'>
          ...
          <button
            ...
            className='bg-[#eb9c57] hover:bg-[#d17f36] w-20 h-12 rounded-full flex justify-center items-center transition'
          >
            <IoMdSearch className='text-[25px] text-white' />
          </button>
        </div>
      </form>
      {/* card */}
